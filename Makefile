...
target_prefix = 
LOCAL_LIBS = 
LIBS = $(LIBRUBYARG_SHARED) -lsandesha2_client -lmod_rampart -lneethi_util -lneethi -laxis2_http_receiver -laxis2_http_sender -laxis2_http_common -laxis2_engine -laxis2_parser -laxutil -lwsdlc -laxis2_axiom  -lpthread -ldl -lobjc 
SRCS = WSFC_wrapper.c
OBJS = WSFC_wrapper.o
TARGET = WSFC
DLLIB = $(TARGET).bundle
