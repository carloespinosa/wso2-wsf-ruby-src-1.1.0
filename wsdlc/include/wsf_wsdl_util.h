...
axis2_status_t
wsf_wsdl_util_get_all_policies_from_wsdl_unified(
    const axutil_env_t* env, 
    axiom_node_t* wsdl_axiom,
    axiom_node_t* binding_node,
    const axis2_char_t* operation_name,
...
void
wsf_wsdl_get_wsdl_imports(
    const axutil_env_t *env,
    axiom_node_t *wsdl_om,
    axis2_char_t *relative_url,
    axutil_hash_t *already_imported_wsdls,
    axutil_array_list_t *imported_wsdl_om_arr);

void wsf_wsdl_attach_xsd_imports(
    const axutil_env_t *env,
    axiom_node_t *wsdl_type_om,
    axiom_node_t *schema_om,
    axis2_char_t *relative_url, axutil_hash_t *already_imported_xsds);

axiom_node_t*
wsf_wsdl_clear_wsdl_imports(
    const axutil_env_t *env,
    axiom_node_t *wsdl_om,
    axis2_char_t *relative_url);

axiom_node_t*
wsf_wsdl_clear_xsd_imports(
    const axutil_env_t *env,
    axiom_node_t *wsdl_om,
    axis2_char_t *relative_url);
