                      ...
                      axis2_char_t* name, void** element)
{
    ...
    if ((parent_element == NULL) || (name == NULL) || (element == NULL))
    {
    ...
    else if (parent_element->children_type == CHILDREN_TYPE_ATTRIBUTES &&
        parent_element->data) /* parent_element->data should contain a pointer to a hash table */   
    {
    ...
    case CHILDREN_TYPE_ATTRIBUTES:
        {
            ...
            axutil_hash_this(index, (const void**)&key, &key_len, &value);
